...
class __TwigTemplate_993ad038600e4cd4b03b33b3110c67c5f7e1b0f8df97d0a0aba0e4284b62d4a4 extends Twig_Template
{
    ...
    <div class=\"panel-heading\">
      ...
      <h3 class=\"panel-title\">
        ...
        ";
            // line 7
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("推荐%name%", array("%name%" => _twig_default_filter($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("classroom.name"), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("班级")))), "html", null, true);
            echo "
      </h3>
    </div>
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["classroom"]) {
              ...
              <a class=\"class-img\" href=\"";
                ...
                // line 16
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFpath($this->getAttribute($context["classroom"], "middlePicture", array()), "classroom.png"), "html", null, true);
                echo "\" alt=\"";
  ...
  ";
            // line 33
            $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->loadScript("course/recommend-classroom");
        }
    }
