...
class __TwigTemplate_a0159354679b0a35cd8ddbfd7611254a4be7736dee528959a97912a8dee4913c extends Twig_Template
{
      ...
      <div class=\"media-body pts\">
        <div class=\"media-heading\">
         <a class=\"title gray-darker\" href=\"";
            ...
            echo "\">";
            echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->subTextFilter($this->getAttribute($context["thread"], "title", array()), 90);
            echo "</a>
          ";
            // line 16
        ...
        <div class=\"metas\">
          ...
          ";
            // line 34
            echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->smarttimeFilter($this->getAttribute($context["thread"], "createdTime", array())), "html", null, true);
            echo "
          ";
            // line 35
          ...
          ";
            ...
            ";
                // line 43
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->smarttimeFilter($this->getAttribute($context["thread"], "lastPostTime", array())), "html", null, true);
                echo "
          ";
            }
            // line 45
