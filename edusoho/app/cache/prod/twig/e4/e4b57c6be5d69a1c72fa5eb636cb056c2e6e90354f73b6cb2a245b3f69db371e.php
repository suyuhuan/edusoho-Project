...
class __TwigTemplate_b20ec49385b872452e4732180800f4ea9fac267f869848294963a160b971af18 extends Twig_Template
{
...
\t\t";
        ...
        <div class=\"piece-header\">
          ";
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("课程介绍"), "html", null, true);
            echo "
        </div>
        <div class=\"piece-body p-lg clearfix\">
          ";
            ...
            if ($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "about", array())) {
                // line 18
                echo "            ";
                echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->cdn($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "about", array()));
                echo "
          ";
            } else {
                // line 20
                echo "            <div class=\"text-muted\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("暂无课程简介"), "html", null, true);
                echo "</div>
          ";
            }
            // line 22
