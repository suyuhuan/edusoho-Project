...
class __TwigTemplate_7e5c8e90feccbdd20587949fdf0e6f2ab166c87a91f6f884ee3b082bae5e6eda extends Twig_Template
{
    ...
    {
        // line 1
        $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->loadScript("review/list");
        // line 2
    ...
    <button class=\"btn btn-primary btn-sm pull-right js-show-review-form\" ";
            ...
            echo ">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("重新评价"), "html", null, true);
            echo "</button>
  </div>
  ...
  <form id=\"review-form\" method=\"post\" action=\"";
    ...
    <div class=\"form-group controls\">
      ";
            // line 9
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("请打分："), "html", null, true);
    ...
    <div class=\"form-group controls\">
      <textarea class=\"form-control\" rows=\"8\" data-display=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("评价详细内容"), "html", null, true);
            echo "\" name=\"content\">";
    ...
    <div class=\"form-group clearfix\">
      <span class=\"text-success pull-left\" style=\"display: none;\">";
            // line 18
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("评价已保存！"), "html", null, true);
            echo "</span>
      ...
      <div class=\"media-body thread-post\">
        <div class=\"title\">";
          ...
          ";
                ...
                if ($this->getAttribute($context["review"], "meta", array())) {
                    echo "<span>";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("课程完成进度"), "html", null, true);
                    echo ":";
        ...
        <div class=\"content\">
          <div class=\"short-content\">";
                // line 47
                echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->subTextFilter($this->getAttribute($context["review"], "content", array()), 100);
                echo "
            ";
                // line 48
                if ($this->getAttribute($context["review"], "updatedTime", array())) {
                    echo "<span class=\"label label-success\">";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("追评"), "html", null, true);
                    echo "</span>";
                }
                // line 49
                echo "          </div>
        ...
        <div class=\"actions clearfix\">
          <a href=\"javascript:;\" class=\"show-full-btn\" style=\"display:none;\">[";
                // line 55
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("展开全文"), "html", null, true);
                echo "]</a>
          <a href=\"javascript:;\" class=\"show-short-btn\" style=\"display:none;\">[";
                // line 56
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("收起全文"), "html", null, true);
                echo "]</a>
          ";
                // line 57
        ...
        ";
                // line 62
                $context["goto"] = ((array_key_exists("goto", $context)) ? (_twig_default_filter((isset($context["goto"]) ? $context["goto"] : null), $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("homepage"))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("homepage")));
                // line 63
                echo "        ";
                if ((((array_key_exists("targetType", $context)) ? (_twig_default_filter((isset($context["targetType"]) ? $context["targetType"] : null), "course")) : ("course")) == "classroom")) {
                    ...
                    // line 66
                    echo "          ";
                    $context["postReplyUrl"] = $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("course_review_post", array("id" => $this->getAttribute($context["review"], "courseId", array()), "reviewId" => $this->getAttribute($context["review"], "id", array())));
                    // line 67
                    echo "        ";
                }
                // line 68
        ...
        <div class=\"thread-subpost-container subcomments clearfix ";
          ...
          ";
              ...
              <div class=\"form-group\">
                ...
                <button type=\"submit\" data-loading-text=\"";
                    // line 89
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("正在发表"), "html", null, true);
          ...
          ";
              ...
              ";
                    ...
                    echo "<a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("login", array("goto" => (isset($context["goto"]) ? $context["goto"] : null))), "html", null, true);
                    echo "\">";
                    ...
                    echo "<a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("register", array("goto" => (isset($context["goto"]) ? $context["goto"] : null))), "html", null, true);
                    echo "\">";
