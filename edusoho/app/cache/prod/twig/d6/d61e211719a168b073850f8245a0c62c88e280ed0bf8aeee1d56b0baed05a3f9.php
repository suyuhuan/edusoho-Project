...
class __TwigTemplate_f9598bd48b98b0e3af5d55d811870ef7bc2b0cb48a532cc9e37fde95212140cd extends Twig_Template
{
    ...
    {
        // line 1
        $context["wxconfig"] = $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->weixinConfig();
        // line 2
        if (((array_key_exists("wxconfig", $context)) ? (_twig_default_filter((isset($context["wxconfig"]) ? $context["wxconfig"] : null), null)) : (null))) {
            // line 3
            echo "\t";
            $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->loadScript("common/weixin-share");
            // line 4
