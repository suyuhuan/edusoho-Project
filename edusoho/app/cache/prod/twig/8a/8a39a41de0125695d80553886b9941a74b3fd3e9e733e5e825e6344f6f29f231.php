...
class __TwigTemplate_710884db4ab38c1337d66de979c63ceeb80c32233a305fefd196fef9e30544f5 extends Twig_Template
{
    ...
    {
        echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->plainTextFilter((isset($context["threadMainContent"]) ? $context["threadMainContent"] : null), 100);
    }
    ...
    <div class=\"panel-heading\">
      <h3 class=\"panel-title\">
        ...
        // line 18
        echo "        ";
        if ($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->isFeatureEnabled("group_reward")) {
            // line 19
            echo "          ";
            ...
            <span style=\"color:#d9534f;\" class=\"mll\"> ";
                // line 22
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("悬赏:%rewardCoin%%coin_name%", array("%rewardCoin%" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "rewardCoin", array()), "%coin_name%" => $this->getAttribute($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("coin"), "coin_name", array()))), "html", null, true);
                echo "</span>
    ...
    <div class=\"panel-body clearfix\" id=\"post-action\">
      <div class=\"well well-sm text-sm color-gray clearfix\" style=\"line-height:20px\">
        ...
        if (($this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "userId", array()) != $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()))) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_uncollect", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
            echo "\" ";
            ...
            // line 39
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_collect", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
            echo "\" ";
        ...
        ";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("发表于%createdTime%", array("%createdTime%" => $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->smarttimeFilter($this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "createdTime", array())))), "html", null, true);
        echo "
        <span class=\"mll\"> ";
        // line 43
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("%hitNum%次查看", array("%hitNum%" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "hitNum", array()))), "html", null, true);
        echo "</span>
      </div>
      ...
      ";
        ...
        <span class=\"glyphicon glyphicon-paperclip\"></span> ";
            // line 53
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("附件下载"), "html", null, true);
            echo " :
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["attach"]) {
                ...
                if ($this->getAttribute($context["attach"], "description", array())) {
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("描述：%description%", array("%description%" => $this->getAttribute($context["attach"], "description", array()))), "html", null, true);
                }
                echo "  ";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("上传于 %createdTime%", array("%createdTime%" => $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->smarttimeFilter($this->getAttribute($this->getAttribute((isset($context["files"]) ? $context["files"] : null), $this->getAttribute($context["attach"], "fileId", array()), array(), "array"), "createdTime", array())))), "html", null, true);
                echo "\">
              ";
                // line 57
                if (((($this->getAttribute($context["attach"], "coin", array()) > 0) && ($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) != $this->getAttribute($context["attach"], "userId", array()))) && $this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()))) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_buy_attach", array("attachId" => $this->getAttribute($context["attach"], "id", array()))), "html", null, true);
                    echo "\" class=\"pull-left mrm\"><img src=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getDefaultPath($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFileType($this->getAttribute($context["attach"], "title", array()), ".png")), "html", null, true);
                    echo "\" class=\"avatar-md\"></a>
              ";
                } else {
                    // line 60
                    echo "                <a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_attach_download", array("fileId" => $this->getAttribute($context["attach"], "id", array()))), "html", null, true);
                    echo "\" class=\"pull-left mrm\"><img src=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getDefaultPath($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFileType($this->getAttribute($context["attach"], "title", array()), ".png")), "html", null, true);
                    echo "\" class=\"avatar-md\"></a>
              ";
                ...
                <div class=\"content\" style=\"color: #999;font-size:11px;\">
                  ";
                // line 72
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->fileSizeFilter($this->getAttribute($this->getAttribute((isset($context["files"]) ? $context["files"] : null), $this->getAttribute($context["attach"], "fileId", array()), array(), "array"), "size", array())), "html", null, true);
                echo "
                  ";
                // line 73
                if (($this->getAttribute($context["attach"], "coin", array()) > 0)) {
                    // line 74
                    echo "                    <span class=\"mls\">";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("售价:%coin%%coin_name%", array("%coin%" => $this->getAttribute($context["attach"], "coin", array()), "%coin_name%" => $this->getAttribute($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("coin"), "coin_name", array()))), "html", null, true);
                    echo "</span>
                    ";
                } else {
                    // line 76
                ...
                // line 78
                echo "                  <br>";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("下载次数：%hitNum%", array("%hitNum%" => $this->getAttribute($context["attach"], "hitNum", array()))), "html", null, true);
                echo "
                </div>
              </div>
            </div>
      ...
      ";
        ...
        ";
        // line 86
        if (($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->isFeatureEnabled("group_reward") && ($this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "count", array()) == 1))) {
            // line 87
            echo "          ";
            if ((((($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) == $this->getAttribute((isset($context["owner"]) ? $context["owner"] : null), "id", array())) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN")) || ($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) == $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "ownerId", array()))) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3))) {
                // line 88
                echo "          ";
            } else {
                // line 89
                ...
                if ($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array())) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_hide", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
                    echo "\">";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("查看隐藏内容"), "html", null, true);
                    echo "</a>
            ";
                }
                // line 92
        ...
        if ((((($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) == $this->getAttribute((isset($context["owner"]) ? $context["owner"] : null), "id", array())) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN")) || ($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) == $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "ownerId", array()))) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3))) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_update", array("id" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "id", array()), "threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
            echo "\"> ";
        ...
        ";
        // line 99
        if (((((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 2) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN")) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3))) {
            // line 100
            echo "          ";
            ...
            data-url=\"";
                // line 103
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_removeElite", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("取消加精"), "html", null, true);
                echo "</a>
          ";
            ...
            href=\"javascript:\" data-url=\"";
                // line 106
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_setElite", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("加精"), "html", null, true);
                echo "</a>
          ";
          ...
          ";
            ...
            href=\"javascript:\" data-url=\"";
                // line 111
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_removeStick", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
                echo "\"> ";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("取消置顶"), "html", null, true);
                echo "</a>
          ";
            ...
            href=\"javascript:\" data-url=\"";
                // line 114
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_setStick", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("置顶"), "html", null, true);
                echo "</a>
          ";
          ...
          ";
            ...
            if ($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->isFeatureEnabled("group_reward")) {
                // line 118
                echo "            ";
                if ((($this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN") || ($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) == $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "ownerId", array()))) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3))) {
                    // line 119
                    echo "              ";
                    if ((($this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "type", array()) == "reward") && ($this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "rewardCoin", array()) > 0))) {
                        // line 120
                        ...
                        if ( !(isset($context["isAdopt"]) ? $context["isAdopt"] : null)) {
                            ...
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("取消悬赏"), "html", null, true);
                            echo "\" class=\"btn btn-default btn-sm mrm\"
                  href=\"javascript:\" data-url=\"";
                            // line 122
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_cancel_reward", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
                ...
                ";
                        ...
                        if (($this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "type", array()) == "default")) {
                            ...
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("悬赏"), "html", null, true);
                            echo "\" class=\"btn btn-default btn-sm mrm\"
                    href=\"javascript:\" data-toggle=\"modal\" data-target=\"#modal\" data-urL=\"";
                            // line 127
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_reward", array("threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
        ...
        if (($this->getAttribute((isset($context["filters"]) ? $context["filters"] : null), "type", array()) == "onlyOwner")) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("查看全部"), "html", null, true);
            echo "</a>
        ";
        } else {
            // line 136
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("只看楼主"), "html", null, true);
            echo "</a>
        ";
        }
        // line 138
        ...
        if (($this->getAttribute((isset($context["filters"]) ? $context["filters"] : null), "sort", array()) == "desc")) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("顺序查看"), "html", null, true);
            echo "</a>
        ";
        } else {
            // line 142
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("倒序查看"), "html", null, true);
            echo "</a>
        ";
        }
        // line 144
  ...
  ";
      ...
      <div class=\"panel-heading\" style=\"color:#d9534f;\">
        ";
                // line 152
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("最佳回答"), "html", null, true);
                echo "
      </div>
      <div class=\"panel-body\">
        <ul class=\"media-list\">
          <li class=\"media\">
            <a href=\"";
                // line 157
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("user_show", array("id" => $this->getAttribute($this->getAttribute((isset($context["isAdopt"]) ? $context["isAdopt"] : null), 0, array(), "array"), "userId", array()))), "html", null, true);
                echo "\" class=\"pull-left\"><img src=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFpath($this->getAttribute($this->getAttribute((isset($context["postMember"]) ? $context["postMember"] : null), $this->getAttribute($this->getAttribute((isset($context["isAdopt"]) ? $context["isAdopt"] : null), 0, array(), "array"), "userId", array()), array(), "array"), "smallAvatar", array()), "avatar.png"), "html", null, true);
                echo "\" class=\"avatar-md\"></a>
            <div class=\"media-body\">
              <div class=\"metas\">
                ...
                <span class=\"mhm\">";
                // line 161
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->smarttimeFilter($this->getAttribute($this->getAttribute((isset($context["isAdopt"]) ? $context["isAdopt"] : null), 0, array(), "array"), "createdTime", array())), "html", null, true);
                echo " </span>
              </div>
              <div class=\"content\">
                ";
  ...
  ";
    ...
    <div class=\"panel-heading\">
      ";
            // line 177
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("%postNum%回复", array("%postNum%" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "postNum", array()))), "html", null, true);
            echo "
    </div>
    <div class=\"panel-body\">
      <ul class=\"media-list\">
        ";
            ...
            <a href=\"";
                // line 184
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("user_show", array("id" => $this->getAttribute($context["post"], "userId", array()))), "html", null, true);
                echo "\" class=\"pull-left\"><img src=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFpath($this->getAttribute($this->getAttribute((isset($context["postMember"]) ? $context["postMember"] : null), $this->getAttribute($context["post"], "userId", array()), array(), "array"), "smallAvatar", array()), "avatar.png"), "html", null, true);
            ...
            <div class=\"media-body\">
              <div class=\"metas\">
                ...
                if (($this->getAttribute((isset($context["filters"]) ? $context["filters"] : null), "sort", array()) == "desc")) {
                    // line 189
                    echo "                    ";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("%postCount%楼", array("%postCount%" => ((((isset($context["postCount"]) ? $context["postCount"] : null) + 1) - ($this->getAttribute((isset($context["paginator"]) ? $context["paginator"] : null), "getPerPageCount", array(), "method") * ($this->getAttribute((isset($context["paginator"]) ? $context["paginator"] : null), "currentPage", array()) - 1))) - $this->getAttribute($context["loop"], "index0", array())))), "html", null, true);
                    echo "
                  ";
                } else {
                    // line 191
                    echo "                    ";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("%loop.index%楼", array("%loop.index%" => (($this->getAttribute($context["loop"], "index", array()) + 1) + ($this->getAttribute((isset($context["paginator"]) ? $context["paginator"] : null), "getPerPageCount", array(), "method") * ($this->getAttribute((isset($context["paginator"]) ? $context["paginator"] : null), "currentPage", array()) - 1))))), "html", null, true);
                    echo "
                  ";
                }
                // line 193
                ...
                <span >";
                // line 196
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->smarttimeFilter($this->getAttribute($context["post"], "createdTime", array())), "html", null, true);
                echo " </span>
              </div>
              ...
              <div class=\"actions\">
                ";
                // line 205
                if ((((($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) == $this->getAttribute($context["post"], "userId", array())) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN")) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3)) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 2))) {
                    // line 206
                    echo "                  <a title=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("确定删除这条回复"), "html", null, true);
                    echo "\" class=\"mhm post-delete-btn\" href=\"javascript:\" data-url=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_deletePost", array("postId" => $this->getAttribute($context["post"], "id", array()))), "html", null, true);
                    echo "\">";
                ...
                if ($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->isFeatureEnabled("group_reward")) {
                    ...
                    if (( !(isset($context["isAdopt"]) ? $context["isAdopt"] : null) && ($this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "type", array()) == "reward"))) {
                        // line 211
                        echo "                    ";
                        if ((($this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN") || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3)) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 2))) {
                            // line 212
                            echo "                      <a title=\"";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("确定采纳这条回复"), "html", null, true);
                            echo "\" class=\"mhm post-adopt-btn\" href=\"javascript:\" data-url=\"";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_adopt", array("postId" => $this->getAttribute($context["post"], "id", array()))), "html", null, true);
                            echo "\">";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("采纳"), "html", null, true);
                            echo "</a>
                    ";
                        }
                        // line 214
              ...
              <div class=\"reply-";
                ...
                if ((isset($context["subPosts"]) ? $context["subPosts"] : null)) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_post", array("groupId" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "id", array()), "threadId" => $this->getAttribute((isset($context["threadMain"]) ? $context["threadMain"] : null), "id", array()))), "html", null, true);
                    echo "\">
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($context["post"], "id", array()), "html", null, true);
                    echo "\">";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("回复内容"), "html", null, true);
                    echo "</label>
                        <div class=\"controls\">
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("正在发表回复"), "html", null, true);
                    echo "\">";
            ...
            <div class=\"row clearfix mtm\">
              ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["attach"]) {
                        ...
                        echo "  ";
                        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("上传于%createdTime%", array("%createdTime%" => $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->smarttimeFilter($this->getAttribute($this->getAttribute((isset($context["postFile"]) ? $context["postFile"] : null), $this->getAttribute($context["attach"], "fileId", array()), array(), "array"), "createdTime", array())))), "html", null, true);
                        echo "\">
                  ";
                        // line 253
                  ...
                  ";
                    ...
                    <div class=\"content\" style=\"color: #999;font-size:11px;\">
                      ";
                        // line 267
                        echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->fileSizeFilter($this->getAttribute($this->getAttribute((isset($context["postFile"]) ? $context["postFile"] : null), $this->getAttribute($context["attach"], "fileId", array()), array(), "array"), "size", array())), "html", null, true);
                        echo "
                      ";
                        // line 268
                        if (($this->getAttribute($context["attach"], "coin", array()) > 0)) {
                            // line 269
                            echo "                        <span class=\"mls\">";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("售价"), "html", null, true);
                            echo ":";
                            echo twig_escape_filter($this->env, $this->getAttribute($context["attach"], "coin", array()), "html", null, true);
                            echo twig_escape_filter($this->env, $this->getAttribute($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("coin"), "coin_name", array()), "html", null, true);
                            echo "</span>
                        ";
                        } else {
                            // line 271
                    ...
                    ";
                        ...
                        if ((((($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()) == $this->getAttribute($context["post"], "userId", array())) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN")) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3)) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 2))) {
                            // line 276
                            echo "                      <a title=\"";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("确定删除此附件"), "html", null, true);
                            echo "\" class=\"mhm post-delete-btn\" href=\"javascript:\" data-url=\"";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_delete_attach", array("goodsId" => $this->getAttribute($context["attach"], "id", array()))), "html", null, true);
                            echo "\">";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("删除"), "html", null, true);
                            echo "</a>
                    ";
  ...
  <div class=\"panel panel-default\">
    <div class=\"panel-heading\">";
        // line 293
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("发表回复"), "html", null, true);
        echo "</div>
    ...
    <div class=\"panel-body\">
      ...
      ";
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array())) {
          ...
          <div class=\"form-group\">
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("editor_download", array("token" => $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->makeUpoadToken("default"))), "html", null, true);
            echo "\"></textarea>
            </div>
          </div>
          ...
          <div class=\"form-group\">
            ...
            // line 313
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("正在回复"), "html", null, true);
      ...
      ";
          ...
          ";
            // line 323
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("你还没有登录，请先"), "html", null, true);
            echo "<a href=\"";
  ...
  ";
    ...
    <div class=\"panel-heading\">";
        // line 333
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("话题作者"), "html", null, true);
        echo "</div>
    <div class=\"panel-body\">
      <div class=\"media\">
        <div class=\"media-left prm\">
          <a class=\"\" href=\"";
        // line 337
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("user_show", array("id" => $this->getAttribute((isset($context["owner"]) ? $context["owner"] : null), "id", array()))), "html", null, true);
        echo "\">
            <img src=\"";
        // line 338
        echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFpath($this->getAttribute((isset($context["owner"]) ? $context["owner"] : null), "smallAvatar", array()), "avatar.png"), "html", null, true);
        ...
        // line 345
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["owner"]) ? $context["owner"] : null), "title", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["owner"]) ? $context["owner"] : null), "title", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("无"))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("无"))), "html", null, true);
        echo "</span>
        </div>
      </div>
    </div>
  ...
  <div class=\"panel panel-default\">
    ...
    <div class=\"panel-body\">
      ";
        // line 358
        $context["hotGroups"] = $this->env->getExtension('Topxia\WebBundle\Twig\Extension\DataExtension')->getData("HotGroup", array("count" => 3));
        // line 359
        echo "      ";
        $context['_parent'] = $context;
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
          ...
          <div class=\"media-left\">
            ...
            echo "\">
              <img src=\"";
            // line 363
            echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFpath($this->getAttribute($context["group"], "logo", array()), "group.png"), "html", null, true);
            echo "\" alt=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($context["group"], "title", array()), "html", null, true);
