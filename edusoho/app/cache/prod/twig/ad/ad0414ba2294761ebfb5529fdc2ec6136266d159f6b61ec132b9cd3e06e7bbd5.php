...
class __TwigTemplate_08cd1664667f0f6031eef2d1a33dcedccbdbae7e205b14f3555b5ac633bf8869 extends Twig_Template
{
  ...
  <div class=\"modal-dialog\">
    <div class=\"modal-content\">
      <div class=\"modal-header\">
        ...
        // line 7
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("上传附件"), "html", null, true);
        echo "</h4>
      </div>
      <div class=\"modal-body\">
        <button class=\"btn btn-default btn-sm upload-img\" style=\"height:33px;\" type=\"button\" data-url=\"";
        // line 10
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_upload", array("group" => "user"));
        echo "\"  >";
        ...
        <span> ";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("(大小不能超过"), "html", null, true);
        echo "<span style=\"color:red;\">2</span>";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("MB，文件类型支持png ,jpg ,gif ,doc ,xls ,txt ,rar ,zip .)"), "html", null, true);
        echo "</span>
        ...
        echo "</th>
          <th>";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("描述"), "html", null, true);
        echo "</th>
          <th>";
        // line 17
        echo twig_escape_filter($this->env, (($this->getAttribute($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("coin"), "coin_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("coin"), "coin_name", array()), "")) : ("")), "html", null, true);
        echo "</th>
          <th>";
        // line 18
      ...
      <div class=\"modal-footer\">
        ...
        // line 33
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("用户下载附件扣除的%name%会在扣除50%之后添加到您的账户", array("%name%" => (($this->getAttribute($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("coin"), "coin_name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("coin"), "coin_name", array()), "")) : ("")))), "html", null, true);
        echo "
          </div>
