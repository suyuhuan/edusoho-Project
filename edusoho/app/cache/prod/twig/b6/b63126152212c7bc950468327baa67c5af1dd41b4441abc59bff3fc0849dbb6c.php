...
class __TwigTemplate_2c587f30b870eea5babc4513fc822fb8c317edccb9a1f99b960f5d0528fd1772 extends Twig_Template
{
            ...
            <a href=\"";
              ...
              ";
                ...
                if ($this->getAttribute($context["featuredArticle"], "thumb", array())) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFpath($this->getAttribute($context["featuredArticle"], "thumb", array()), ""), "html", null, true);
                    echo "\" alt=\"";
      ...
      ";
        ...
        ";
                ...
                if ($this->getAttribute($context["promotedArticle"], "thumb", array())) {
                    // line 34
                    echo "          <img class=\"img-responsive\" src=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getFpath($this->getAttribute($context["promotedArticle"], "thumb", array()), ""), "html", null, true);
                    echo "\" alt=\"";
        ...
        ";
          ...
          <h4 class=\"title\">";
                // line 40
                echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->plainTextFilter($this->getAttribute($context["promotedArticle"], "title", array()), 125);
                echo "</h4>
        </div>
        <div class=\"image-overlay\"></div>
      </a>
