...
class __TwigTemplate_998b0b13cc716e679b680981776880800a683ea2229276d906415c92d2dc953f extends Twig_Template
{
...
";
        // line 14
        if ((((($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array()) && $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("magic.lesson_watch_limit")) && ($this->getAttribute((isset($context["course"]) ? $context["course"] : null), "watchLimit", array()) > 0)) && ($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "type", array()) == "video")) &&  !((array_key_exists("fromPlugin", $context)) ? (_twig_default_filter((isset($context["fromPlugin"]) ? $context["fromPlugin"] : null), false)) : (false)))) {
            // line 15
            echo "  ";
            ...
            if (((isset($context["remainTime"]) ? $context["remainTime"] : null) > 0)) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("还剩"), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->durationTextFilter((isset($context["remainTime"]) ? $context["remainTime"] : null)), "html", null, true);
                echo "</small>
  ";
            } else {
                // line 19
                echo "    <small class=\"text text-info\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("已达最大可看时长"), "html", null, true);
                echo "</small>
  ";
            }
        }
...
";
        ...
        if (($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "status", array()) == "published")) {
            ...
            if (($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "type", array()) == "video")) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->durationFilter($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "length", array())), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->durationFilter($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "length", array())), "html", null, true);
                echo "</span>
    <span class=\"course-type\">
      <i class=\"es-icon es-icon-videoclass\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"";
                // line 29
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("视频课程"), "html", null, true);
                echo "\"></i>
    </span>
  ";
            }
  ...
  ";
    ...
    <span class=\"course-type\">
      <i class=\"es-icon es-icon-audioclass\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"";
                // line 36
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("音频课程"), "html", null, true);
                echo "\"></i>
    </span>
  ";
            }
  ...
  ";
      ...
      <i class=\"es-icon es-icon-graphicclass\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"";
                // line 42
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("图文课程"), "html", null, true);
                echo "\" data-original-title=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("图文"), "html", null, true);
                echo "\"></i>
    </span>
  ";
            }
    ...
    ";
        ...
        ";
                    ...
                    if (($this->getAttribute(twig_date_converter($this->env), "timestamp", array()) < $this->getAttribute((isset($context["item"]) ? $context["item"] : null), "testStartTime", array()))) {
                        // line 52
                        echo "            ";
                        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("考试倒计时"), "html", null, true);
                        echo ":<span class=\"color-primary pls\">";
                        echo twig_escape_filter($this->env, $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->remainTimeFilter($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "testStartTime", array())), "html", null, true);
                        echo "</span>
        ";
                    } else {
                        // line 54
                        ...
                        if (($this->getAttribute(twig_date_converter($this->env), "timestamp", array()) < (isset($context["endTime"]) ? $context["endTime"] : null))) {
                            // line 55
                            echo "              ";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("考试已开始"), "html", null, true);
                            echo "
          ";
                        } else {
                            // line 57
                            echo "              ";
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("考试已结束"), "html", null, true);
                            echo "
          ";
                        }
                        // line 59
  ...
  ";
      ...
      <i class=\"es-icon es-icon-pptclass\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"";
                // line 70
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("PPT课程"), "html", null, true);
                echo "\"></i>
    </span>
  ";
            }
  ...
  ";
      ...
      <i class=\"es-icon es-icon-description\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"";
                // line 76
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("文档课程"), "html", null, true);
  ...
  ";
      ...
      <i class=\"es-icon es-icon-flashclass\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"";
                // line 82
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("flash课程"), "html", null, true);
                echo "\"></i>
    </span>
  ";
            }
    ...
    <span class=\"course-type\">
      ...
      ";
                ...
                if (($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "startTime", array()) > (isset($context["currentTime"]) ? $context["currentTime"] : null))) {
                    ...
                    echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["item"]) ? $context["item"] : null), "startTime", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("m月d日")), "html", null, true);
                    echo "
          ";
                    // line 97
                    echo "          ";
