...
class __TwigTemplate_bea18dc17584d01611e231043eae520048dc9ac3116877447b5a300ee0a8a730 extends Twig_Template
{
    ...
    {
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("%title%小组", array("%title%" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "title", array()))), "html", null, true);
        echo " ";
    ...
    {
        echo $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->plainTextFilter(((array_key_exists("groupAbout", $context)) ? (_twig_default_filter((isset($context["groupAbout"]) ? $context["groupAbout"] : null), "")) : ("")), 100);
    }
    ...
    <div class=\"panel-heading\"><h3 class=\"panel-title\">";
        // line 13
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("小组介绍"), "html", null, true);
        echo "</h3></div>
  ...
  <div class=\"panel panel-default\">
    <div class=\"panel-body\">
      <ul class=\"nav nav-tabs\">
        ...
        echo "><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_show", array("id" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "id", array()))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("小组首页"), "html", null, true);
        echo "</a></li>
        <li ";
        // line 26
        ...
        echo "><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_member", array("id" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "id", array()))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("小组成员"), "html", null, true);
        echo "</a></li>
        ";
        // line 27
        if (((((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 2) || $this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN")) || ((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3))) {
            ...
            echo "><a  href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_set", array("id" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "id", array()))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("小组设置"), "html", null, true);
            echo "</a></li>
        ";
        }
        // line 30
...
";
    ...
    public function block_group_side($context, array $blocks = array())
    {
        ...
        if (((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) != 0)) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_thread_add", array("id" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "id", array()))), "html", null, true);
  ...
  ";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_search", array("id" => $this->getAttribute((isset($context["groupinfo"]) ? $context["groupinfo"] : null), "id", array()))), "html", null, true);
        echo "\" method=\"get\">
  <div class=\"search-with-btn\">
    ...
    <input type=\"text\" class=\"form-control\" placeholder=\"";
        // line 83
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("组内搜索"), "html", null, true);
        echo "\" name=\"keyWord\">
        ...
        <div class=\"media group-item\">
          ...
          <div class=\"media-body\">
            ...
            if (((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 1)) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("组员"), "html", null, true);
                echo "</span>
              ";
            }
            // line 100
            ...
            if (((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 2)) {
                // line 102
                echo "              <span class=\"label label-primary\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("组长"), "html", null, true);
                echo "</span>
              ";
            }
            // line 104
            ...
            if (((isset($context["is_groupmember"]) ? $context["is_groupmember"] : null) == 3)) {
                // line 106
                echo "              <span class=\"label label-primary\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("副组长"), "html", null, true);
                echo "</span>
              ";
            }
            // line 108
            ...
            <a href=\"";
            // line 109
            echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("group_member_center");
  ...
  ";
    ...
    <div class=\"panel-heading\"><h3 class=\"panel-title\">";
        // line 121
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("小组组长"), "html", null, true);
        echo "</h3></div>
    <div class=\"panel-body\">
      <div class=\"media group-item\">
        <div class=\"media-left\">
        ...
        // line 128
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("user_show", array("id" => $this->getAttribute((isset($context["groupOwner"]) ? $context["groupOwner"] : null), "id", array()))), "html", null, true);
        echo "\" title=\"";
        ...
        // line 129
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["groupOwner"]) ? $context["groupOwner"] : null), "title", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["groupOwner"]) ? $context["groupOwner"] : null), "title", array()), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("无"))) : ($this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("无"))), "html", null, true);
        echo "</span>
        </div>
      </div>
    </div>
