...
class __TwigTemplate_ab5169e9caa8d8d932bae6505cd348a77be263e80e02e92d8728b1db1996ad98 extends Twig_Template
{
          ...
          ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["c"]) {
                        ...
                        if (($this->getAttribute($context["loop"], "index", array()) == 1)) {
                            ...
                            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("article_category", array("categoryCode" => (isset($context["nextCode"]) ? $context["nextCode"] : null))), "html", null, true);
                            echo "\">";
