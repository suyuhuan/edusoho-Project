...
class __TwigTemplate_3ea3da730c0393915ce014916edc6551b9bb5148042624aa06cd48993349b80f extends Twig_Template
{
...
";
        // line 3
        $this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->loadScript("classroombundle/controller/classroom/teachers");
        // line 4
        echo "
<div class=\"panel panel-default\" id=\"class-teacher-column\">
  ...
  <div class=\"panel-body\">
    ...
    ";
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("该%name%尚未设置班主任", array("%name%" => _twig_default_filter($this->env->getExtension('Topxia\WebBundle\Twig\Extension\WebExtension')->getSetting("classroom.name"), $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("班级")))), "html", null, true);
            echo "</div>
    ";
        }
        // line 32
