...
class appProdProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'luefenzziy8os8sw444kgk00k040sos', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=127.0.0.1;port=3306;dbname=edusoho', 'root', '');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('luefenzziy8os8sw444kgk00k040sos');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'zh_CN',
            'secret' => 'luefenzziy8os8sw444kgk00k040sos',
            'webpack_base_url' => 'http://www.xcmaly.cn',
            'user_partner' => 'none',
            'biz_config' => array(
                'debug' => false,
                'db.options' => array(
            ...
            'doctrine.config_paths' => array(
                '/usr/local/apache2/htdocs/edusoho/app/../vendor/bshaffer/oauth2-server-bundle/OAuth2/ServerBundle/Resources/config/doctrine' => 'OAuth2\\ServerBundle\\Entity',
            ),
            ...
            'kernel.secret' => 'luefenzziy8os8sw444kgk00k040sos',
